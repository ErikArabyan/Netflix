export const Marker = () => {
	return (
		<svg xmlns='http://www.w3.org/2000/svg' fill='none' role='img' viewBox='0 0 20 20' width='18' height='18' data-icon='CheckmarkStandard' aria-hidden='true' style={{verticalAlign: 'top', marginRight: '5px'}}>
