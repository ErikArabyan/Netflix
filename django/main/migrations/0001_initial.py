    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rate', models.FloatField(blank=True, null=True, verbose_name='Film Rate')),
                ...
                ('film', models.ManyToManyField(related_name='Film', to='main.preview')),
                ...
                ('preview', models.ManyToManyField(related_name='Preview', to='main.video')),
            ],
        ),
    ]
